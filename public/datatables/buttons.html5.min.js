    ...
    action: function (a, c, d, b) {
      ...
      if (k.queryCommandSupported("copy")) {
        ...
        try {
          ...
          if (f) {
            c.buttons.info(
              c.i18n("buttons.copyTitle", "Copiado al Portapapeles con Exito"),
              c.i18n(
                "buttons.copySuccess",
                {
                  1: "Copied one row to clipboard",
                  _: "Se Copiaron %d Filas al Porta Papeles",
                },
                a.rows
              ),
              2e3
      ...
      c.buttons.info(c.i18n("buttons.copyTitle", "Copiado al Portapapeles con Exito"), f, 0);
      b[0].focus();
      b[0].select();
